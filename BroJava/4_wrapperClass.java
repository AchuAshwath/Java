...
class wrapperClass{
    public static void main(String[] args) {
        ...
        // unBoxing - the reverse of autoBoxing. Automatically converting an object of a wrapper class 
        ...
        // here the primitive type is compared with the Boolean reference type via the autoBoxing process
        // the autoBoxing process converts the primitive type to the Boolean reference type
        ...
        // here the Boolean reference type is compared with the primitive type via the unBoxing process
        // the unBoxing process converts the Boolean reference type to the primitive type
